...
class HomeFrame extends JFrame {
    ...
    HomeFrame() {
        ...
        setResizable(true); // the resize option is greyed out
...
class DatabaseHandler {
    ...
    public static void getConnection() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "system", "457");
    ...
    public void insert(int id, String name, String address, String designation, int salary) {
        try {
            getConnection();
    ...
    public String query() {
        ...
        try {
            ...
            sb.append("ID" + "\t" + "NAME" + "\t" + "ADDRESS" + "\t" + "DESIGNATION" + "\t" + "SALARY" + "\n");
            while (rs.next()) {
